...
const Footer = () => {
  ...
  <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
    <a class="flex  font-medium items-center md:justify-start justify-center " href='#home'>
      <img src='./axes.png' alt="" className='w-40 h-40' />
      
    </a>
    <p class="text-xl text-white sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">© 2022 Zap Technology 
     </p> 
